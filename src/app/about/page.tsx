    ...
    <div className="min-h-screen bg-bg-page text-text-page selection:bg-accent selection:text-primary relative overflow-x-hidden pb-24">
      ...
      <main className="relative z-10 w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-16">
        ...
        <div className="text-center mb-24 max-w-3xl mx-auto">
          ...
          <h1 className="font-serif italic text-4xl sm:text-5xl md:text-6xl text-text-page font-light tracking-wide leading-tight mb-8">
          ...
          <p className="text-text-dim text-xs sm:text-sm font-light uppercase tracking-widest leading-relaxed">
        ...
        <motion.div
          ...
          className="bg-bg-card border border-border-theme rounded-3xl p-8 sm:p-12 md:p-16 mb-24 relative overflow-hidden shadow-xl"
        >
          {/* Subtle logo backing */}
          ...
          <p className="text-text-muted text-xs sm:text-sm leading-relaxed mb-8 max-w-2xl font-light">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="border border-border-theme rounded-xl p-4 bg-bg-page/40">
              <h3 className="text-xs font-semibold text-primary uppercase tracking-wider mb-2">I. GOTHIC TYPOGRAPHY</h3>
              <p className="text-[10px] sm:text-xs text-text-dim font-light leading-relaxed">Bold calligraphic forms representing strength, history, and sacred text.</p>
            </div>
            <div className="border border-border-theme rounded-xl p-4 bg-bg-page/40">
              <h3 className="text-xs font-semibold text-primary uppercase tracking-wider mb-2">II. THE OXBLOOD GLOW</h3>
              <p className="text-[10px] sm:text-xs text-text-dim font-light leading-relaxed">A signature deep red accent stitching and interior details symbolizing devotion.</p>
            </div>
            <div className="border border-border-theme rounded-xl p-4 bg-bg-page/40">
              <h3 className="text-xs font-semibold text-primary uppercase tracking-wider mb-2">III. HAND-NUMBERED TAG</h3>
              <p className="text-[10px] sm:text-xs text-text-dim font-light leading-relaxed">Unique drops limited to exactly 64 replicas per silhouette.</p>
            </div>
          </div>
        </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {pillars.map((pillar, idx) => (
              <motion.div
                ...
                className="bg-bg-card/50 border border-border-theme rounded-2xl p-6 flex flex-col justify-between hover:border-primary/20 transition-all duration-300 hover:bg-bg-card-alt/50"
              >
                <div>
                  <h3 className="text-sm font-semibold tracking-widest text-text-page mb-1 font-mono">{pillar.title}</h3>
                  <h4 className="text-[10px] text-primary/75 italic font-serif mb-4 uppercase tracking-wider">{pillar.subtitle}</h4>
                  <p className="text-xs text-text-muted font-light leading-relaxed">{pillar.desc}</p>
                </div>
